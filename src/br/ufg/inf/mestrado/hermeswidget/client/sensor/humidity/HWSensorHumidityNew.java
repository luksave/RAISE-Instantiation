...
public class HWSensorHumidityNew extends HermesWidgetSensorClient implements Runnable {
	...
	public HWSensorHumidityNew(File registroAtual, String tempo[]) {
	...
	public void run(){
		...
		try {
			...
			HWTransferObject hermesWidgetTO = representationService.startRepresentationSensor(
					...
					"RelHum", countRHum, 
					"RelativeHumidity", // Nome do topico no arquivo topics_vocs
					medicaoAtual, 
