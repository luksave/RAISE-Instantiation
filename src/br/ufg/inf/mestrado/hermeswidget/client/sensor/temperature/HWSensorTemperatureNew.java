...
public class HWSensorTemperatureNew extends HermesWidgetSensorClient implements Runnable {
	...
	public HWSensorTemperatureNew(File registroAtual, String tempo[]) {
	...
	public void run(){
		...
		try {
			...
			HWTransferObject hermesWidgetTO = representationService.startRepresentationSensor(
					"temperature.ttl", Integer.toString(segundos), 
					"Temp", countTEMP, 
					"Temperature", // Nome do topico no arquivo topics_vocs
					medicaoAtual, 
