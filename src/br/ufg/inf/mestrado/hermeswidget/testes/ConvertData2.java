...
public class ConvertData2 {
	...
	public static void convert() {
		...
		*/
		...
		Statement temParticipante = ResourceFactory.createStatement(
				ResourceFactory.createResource("http://www.semanticweb.org/ontologies/2013/1/Ontology1361391792831.owl#"+monitoring),
				ResourceFactory.createProperty("http://www.semanticweb.org/ontologies/2013/1/Ontology1361391792831.owl#hasParticipant"),
				ResourceFactory.createResource("http://www.semanticweb.org/ontologies/2013/1/Ontology1361391792831.owl#"+entity));
		
		resultModel.add(temParticipante);
		...
		*/
		...
		Property p = resultModel.getProperty("http://www.semanticweb.org/ontologies/2013/1/Ontology1361391792831.owl#unitTemperature");
		ResIterator iterator = resultModel.listSubjectsWithProperty(p);
		entityID = null;
		while (iterator.hasNext()) {
		    entityID = iterator.next().getURI();
